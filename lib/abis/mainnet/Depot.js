export default [ { constant: false,
  ...
  { constant: false,
    inputs:
     [ { name: 'synthAmount', type: 'uint256' },
       { name: 'guaranteedRate', type: 'uint256' } ],
  ...
  { anonymous: false,
    inputs:
     [ { indexed: false, name: 'newFundsWallet', type: 'address' } ],
  ...
  { anonymous: false,
    inputs:
     [ { indexed: false, name: 'newSynthContract', type: 'address' } ],
    name: 'SynthUpdated',
    type: 'event' },
  { anonymous: false,
  ...
  { anonymous: false,
    inputs:
     [ { indexed: false, name: 'priceStalePeriod', type: 'uint256' } ],
