export default [
  ...
  {
    constant: false,
    inputs: [{ name: 'to_addr', type: 'address' }],
    name: 'recoverETH',
    outputs: [],
    payable: false,
  ...
  {
    constant: false,
    inputs: [{ name: '_exchangeRatesAddress', type: 'address' }],
  ...
  },
  {
    constant: false,
    inputs: [
      { name: '_acceptable_slippage', type: 'uint256' },
      { name: '_max_delay', type: 'uint256' },
      { name: '_off_peg_min', type: 'uint256' },
    ],
    name: 'setParams',
    outputs: [],
    payable: false,
  ...
  {
    constant: false,
    inputs: [{ name: '_synthAddress', type: 'address' }],
  ...
  {
    constant: false,
    inputs: [{ name: 'erc20_addr', type: 'address' }, { name: 'to_addr', type: 'address' }],
    name: 'recoverERC20',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    inputs: [],
    name: 'arbSynthRate',
    outputs: [{ name: 'reward_tokens', type: 'uint256' }],
    payable: true,
  ...
  {
    constant: false,
    inputs: [{ name: '_uniswapAddress', type: 'address' }],
