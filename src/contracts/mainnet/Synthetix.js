   ...
   **/
      this.feeRateForExchange = async (sourceCurrencyKey, destinationCurrencyKey) => {
        return await this.contract.feeRateForExchange(sourceCurrencyKey, destinationCurrencyKey).call({ _isConstant: true })
      };
   ...
   **/
      this.effectiveValue = async (sourceCurrencyKey, sourceAmount, destinationCurrencyKey) => {
        return await this.contract.effectiveValue(sourceCurrencyKey, sourceAmount, destinationCurrencyKey).call({ _isConstant: true })
      };
   ...
   **/
      this.remainingIssuableSynths = async (issuer, currencyKey) => {
        return await this.contract.remainingIssuableSynths(issuer, currencyKey).call({ _isConstant: true })
      };
   ...
   **/
    this.synthInitiatedExchange = async (from, sourceCurrencyKey, sourceAmount, destinationCurrencyKey, destinationAddress, txParams) => {
      txParams = txParams || {};
      const txHash = await this.contract.synthInitiatedExchange(from, sourceCurrencyKey, sourceAmount, destinationCurrencyKey, destinationAddress).send(txParams);
      return { hash: txHash };
    };
   ...
   **/
    this.setProtectionCircuit = async (_protectionCircuitIsActivated, txParams) => {
      txParams = txParams || {};
      const txHash = await this.contract.setProtectionCircuit(_protectionCircuitIsActivated).send(txParams);
      return { hash: txHash };
    };
   ...
   **/
    this.exchange = async (sourceCurrencyKey, sourceAmount, destinationCurrencyKey, txParams) => {
      txParams = txParams || {};
      const txHash = await this.contract.exchange(sourceCurrencyKey, sourceAmount, destinationCurrencyKey).send(txParams);
      return { hash: txHash };
    };
